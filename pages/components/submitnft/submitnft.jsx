...
function SubmitNFT() {
  ...
  const [
    databaseInformationUploadIsLoading,
    setDatabaseInformationUploadIsLoading,
  ] = useState(false);
  ...
  const HandleSubmit = async (event, walletAddress) => {
    ...
    try {
      setDatabaseInformationUploadIsLoading(true);
      await mutateAsync({
        args: [
          randomNumber,
          recipientAddress,
      ...
      form.reset();
      setDatabaseInformationUploadIsLoading(false);
    } catch (error) {
    ...
    `}
      >
        {!address ? (
          ...
          <form
            id="uploadForm"
            className="h-full w-4/5 text-[rgba(255,255,255,0.7)] flex justify-between items-center"
            onSubmit={(event) => HandleSubmit(event, address)}
            noValidate
          >
            <div className="h-4/5 w-[65%] flex flex-col justify-between items-center">
              <div className="h-[35%] w-full bg-[rgba(255,255,255,0.125)] rounded-3xl flex flex-col justify-center items-center gap-4">
                  ...
                  <div className="flex flex-col w-[30%] gap-2">
                    ...
                    >
                      ...
                      <option
                        ...
                        className="!bg-[rgba(255,255,255,0.25)] !text-[rgba(255,255,255,0.7)]"
                      >
                        Certification: Obtain a project management
                        certification.
                      </option>
                      <option
                      ...
                      <option
                        ...
                        className="!bg-[rgba(255,255,255,0.25)] !text-[rgba(255,255,255,0.7)]"
                      >
                        Volunteer Hours: Contribute 50 hours of community
                        service.
                      </option>
                      <option
                      ...
                      <option
                        ...
                        className="!bg-[rgba(255,255,255,0.25)] !text-[rgba(255,255,255,0.7)]"
                      >
                        Team Project Success: Successfully complete a team
                  ...
                  <div className="flex flex-col w-[30%] gap-2">
                    ...
                    >
                      ...
                      <option
                        ...
                        className=""
                      >
                        Research Project: Conduct an original research project
                      ...
                      <option
                        ...
                        className=""
                      >
                        Mentorship: Receive mentoring from an industry expert
                      ...
                      <option
                        ...
                        className=""
                      >
                        Fundraising Campaign: Successfully organize and execute
                        a fundraising campaign for a charitable cause.
                      </option>
                      <option
                      ...
                      <option
                        ...
                        className=""
                      >
                        Wellness Challenge: Participate in and complete a
                        fitness or wellness challenge.
                      </option>
                      <option
              ...
              <div className="h-[35%] w-full bg-[rgba(255,255,255,0.125)] rounded-3xl flex flex-col justify-center items-center gap-4">
                <h1 className="text-xl font-medium">Time:</h1>
                <div className="w-4/5 flex justify-between">
                  <div className="flex justify-around w-full">
                    <input
                      ...
                      id="hours"
                      min="0"
                      className="rounded-md text-center text-[rgba(255,255,255,0.7)] placeholder:text-[1rem] placeholder:text-center bg-[rgba(255,255,255,0.25)] w-[30%] focus:outline-none placeholder:text-[rgba(255,255,255,0.4)] h-[2rem]"
                      placeholder="Hours"
                    />
                    <input
                      type="number"
              ...
              <div className="h-[16%] w-full bg-[rgba(255,255,255,0.125)] rounded-3xl flex justify-between items-center px-10">
                <button
                  type="button"
                  className="w-2/5 bg-[rgba(255,255,255,0.25)] hover:bg-[rgba(255,255,255,0.5)] duration-500 h-3/5 rounded-md font-medium"
                ...
                <button
                  type="submit"
                  className="w-2/5 bg-[rgba(4,212,227,0.25)] hover:bg-[rgba(4,212,227,0.5)] duration-500 h-3/5 rounded-md font-medium"
                >
                  Submit
                </button>
              </div>
            </div>
            <div className="h-4/5 w-[30%] flex flex-col justify-center items-center">
              <div className="h-full w-full bg-[rgba(255,255,255,0.125)] rounded-3xl flex flex-col justify-evenly">
                <div className="flex flex-col w-full items-center gap-6 my-6 relative">
                  <h1 className=" text-xl">Upload Image</h1>
                  <div className="relative flex w-4/5 h-auto max-w-[260px] justify-center items-center hover:cursor-pointer">
                    <Image
                      src={selectedImage || upload}
                      height={1000}
                      width={1000}
                      alt="Uploaded Image"
                      className="max-h-[256px] max-w-[256px] overflow-y-hidden w-auto text-center"
                    />
                    <input
                      id="imagefile"
                      type="file"
                ...
                <div className="flex flex-col w-full items-center gap-2">
                  <h1 className={`text-[rgba(255,255,255,0.7)] text-xl`}>
                    Crypto
                  </h1>
      ...
      >
            ...
            <div className="h-full w-full bg-[rgba(255,255,255,0.25)] rounded-xl flex flex-col justify-between">
              ...
              <div className="flex w-full justify-center gap-[2%]">
                <button
                  type="button"
                  onClick={handleCancel}
                  className="w-1/2 rounded-bl-xl bg-[rgba(255,255,255,0.25)] hover:bg-[rgba(255,255,255,0.5)] duration-500  text-[rgba(255,255,255,0.7)] font-medium py-2 px-4 rounded"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="w-1/2 rounded-br-xl bg-[rgba(4,212,227,0.25)] hover:bg-[rgba(4,212,227,0.5)] duration-500 text-blue-accent font-medium py-2 px-4 rounded"
                >
                  Submit
                </button>
              </div>
        ...
        <LoadingModal isLoading={databaseInformationUploadIsLoading} />
      </div>
    </>
  );
}
